        ...
        Dialog(onDismissRequest = onDismissRequest) {
            Card{
                ...
                when(loading) {
                    ...
                    false -> {
                        Text(text = "Are you sure you want to delete this account? Deleting this account is irreversible", modifier = Modifier.padding(vertical = 10.dp, horizontal = 20.dp))
                    }
                }
                Row(
                    modifier = Modifier
